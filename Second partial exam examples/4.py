...
if __name__ == '__main__':
    ...
    #     dataset.append([dataset[i][j] for j in range(len(dataset[i])) if j != col_index])
    ...
    sample = [el for el in input().split(" ")]

    sample = [sample[i] for i in range(len(sample)) if i != col_index]
