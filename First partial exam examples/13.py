...
class Football(Problem):
    def __init__(self, initial, opponents, illegal, goal=None):
    ...
    def successor(self, state):
        ...
        for move in moves:
            ...
            new_man_x, new_man_y = man[0]+move[0], man[1]+move[1]
            if (new_man_x, new_man_y) == ball:
                new_ball_x, new_ball_y = ball[0]+move[0], ball[1]+move[1]
                if self.check_valid(new_ball_x, new_ball_y) and self.check_valid(new_man_x, new_man_y) and (new_ball_x, new_ball_y) not in self.illegal:
                    action = f'Turni topka {actions[index]}'
                    successors[action] = ((new_man_x, new_man_y), (new_ball_x, new_ball_y))
            else:
                if self.check_valid(new_man_x, new_man_y):
                    action = f'Pomesti coveche {actions[index]}'
                    successors[action] = ((new_man_x, new_man_y), ball)
    ...
    def h(self, node):
        ...
        distance1 = abs(ball[0] - self.goal[0][0]) + abs(ball[1] - self.goal[0][1])
        distance2 = abs(ball[0] - self.goal[1][0]) + abs(ball[1] - self.goal[1][1])

        return max(distance1, distance2)/2
...
if __name__ == '__main__':
    ...
    opponents = [(3, 3), (5, 4)]
    illegal = [(2, 2), (2, 3), (2, 4), (3, 2), (3, 4), (4, 2), (4, 3), (4, 4), (4, 5), (5, 3), (5, 5), (6, 3),
               (6, 4), (6, 5)]
    ...
    football = Football(initial, opponents, illegal, goal_pos)
